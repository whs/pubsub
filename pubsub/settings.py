...
SECRET_KEY = 'hh9xuvm3ryr&&f&sg@x)iw87=s0f6u5-v$755!xkuw(e2(r!80'
...
CELERY_BROKER_TRANSPORT_OPTIONS = {'project_id': PROJECT_ID}
...
CELERY_EVENT_QUEUE_PREFIX = 'pubsub-celeryev'
